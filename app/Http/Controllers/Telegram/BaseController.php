...
class TelegramController extends Controller
{
    ...
    private function processCommand($chatId, $text)
    {
        ...
        switch ($text) {
            ...
            case 'Завершить задачу':
                return $this->completeTaskFromCurrent($chatId);
            case 'Остановить таймер':
                return $this->stopTimerFromGlobal($chatId);
            default:
    ...
    {
        $text = "Задача 'Завершить разработку Telegram бота' запущена.";
        return ['text' => $text, 'keyboard' => $this->getCurrentTaskKeyboard()];
    }

    private function completeTaskFromCurrent($chatId)
    {
        $text = "Задача 'Завершить разработку Telegram бота' завершена.";
        return ['text' => $text, 'keyboard' => $this->getMainKeyboard()];
    }

    private function stopTimerFromGlobal($chatId)
    {
        $text = "Время зафиксировано";
        return ['text' => $text, 'keyboard' => $this->getMainKeyboard()];
    }
